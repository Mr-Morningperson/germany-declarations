# Declarations of terms tracked in the *germany* collection
...
You can [explore the tracked versions](https://github.com/Mr-Morningperson/germany-versions) interactively or [download them as a dataset](https://github.com/Mr-Morningperson/germany-versions/releases) in the `Mr-Morningperson/germany-versions` repository.
